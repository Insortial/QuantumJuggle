...
class GameScene(Scene):
    def __init__(self) -> None:
        ...
        self.quantum_paddles = paddle.QuantumPaddles(globals.FIELD_HEIGHT - globals.WIDTH_UNIT * 3.45)
    ...
    def update(self, sm):
        ...
        if self.quantum_computer.lives == 0:
            sm.push(LoseScene())

    def draw(self, sm, screen):
        self.circuit_grid.draw(screen)
        ui.draw_statevector_grid(screen)
        ui.draw_score(screen, self.quantum_computer.lives)
